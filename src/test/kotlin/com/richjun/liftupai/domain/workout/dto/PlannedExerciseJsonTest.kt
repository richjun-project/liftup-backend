...
class PlannedExerciseJsonTest {
    ...
    @Test
    fun `should deserialize sets as integer using Spring ObjectMapper`() {
        val json = """
            {
                "exercise_id": 1,
                "exercise_name": "벤치프레스",
    ...
    @Test
    fun `should deserialize sets as array using Spring ObjectMapper`() {
        val json = """
            {
                "exercise_id": 1,
                "exercise_name": "벤치프레스",
    ...
    @Test
    fun `should deserialize StartWorkoutRequest with mixed sets formats`() {
        val json = """
            {
                "planned_exercises": [
                    {
