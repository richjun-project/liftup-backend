...
-- 벤치프레스 템플릿
INSERT IGNORE INTO exercise_templates (exercise_id, experience_level, workout_goal, sets, min_reps, max_reps, weight_percentage, rest_seconds, set_type, notes)
SELECT e.id, 'BEGINNER', 'MUSCLE_GAIN', 3, 8, 12, 0.5, 90, 'WORKING', '체중의 50%로 시작'
FROM exercises e WHERE e.name = 'Bench Press';

INSERT IGNORE INTO exercise_templates (exercise_id, experience_level, workout_goal, sets, min_reps, max_reps, weight_percentage, rest_seconds, set_type)
