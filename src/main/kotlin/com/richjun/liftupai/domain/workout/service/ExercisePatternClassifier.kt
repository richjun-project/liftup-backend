...
class ExercisePatternClassifier {
    ...
    private val simplePatternKeywords = mapOf(
        ...
        // CRUNCH/LEG_RAISE를 DECLINE_PRESS보다 먼저 체크 — "Decline Crunch"가 DECLINE_PRESS로 잘못 분류되는 것 방지
        ...
        MovementPattern.DECLINE_PRESS to listOf("decline bench", "decline press"),
