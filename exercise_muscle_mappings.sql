-- 운동별 근육군 매핑 데이터
-- comprehensive_exercises_v2.sql 실행 후 이 파일을 실행하세요
USE liftupai_db;
...
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'CHEST', false FROM exercises e WHERE e.name = '클로즈그립 벤치프레스';
...
-- 덤벨 플라이 계열
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'CHEST' FROM exercises e WHERE e.name LIKE '%플라이%' AND e.category = 'CHEST';

-- 푸시업 계열
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'CHEST' FROM exercises e WHERE e.name LIKE '%푸시업%';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
...
-- 딥스
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'CHEST' FROM exercises e WHERE e.name LIKE '%딥스%' AND e.category = 'CHEST';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
...
-- 루마니안 데드리프트 (햄스트링 우선)
-- 루마니안 데드리프트는 햄스트링이 주요 근육이므로 별도 처리 필요
...
-- 이두근 운동
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'BICEPS' FROM exercises e WHERE (e.name LIKE '%컬%' AND e.category = 'ARMS' AND e.name NOT LIKE '%리스트%' AND e.name NOT LIKE '%레그%');
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'FOREARMS' FROM exercises e WHERE (e.name LIKE '%컬%' AND e.category = 'ARMS' AND e.name NOT LIKE '%리스트%' AND e.name NOT LIKE '%레그%');
...
-- 버피 (전신)
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'CHEST', false FROM exercises e WHERE e.name = '버피';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
...
-- 풀오버 (가슴과 등)
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'LATS' FROM exercises e WHERE e.name LIKE '%풀오버%';

-- 굿모닝 (햄스트링과 등)
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'HAMSTRINGS' FROM exercises e WHERE e.name = '굿모닝';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'BACK' FROM exercises e WHERE e.name = '굿모닝';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'GLUTES' FROM exercises e WHERE e.name = '굿모닝';

-- 글루트 햄 레이즈
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'HAMSTRINGS' FROM exercises e WHERE e.name LIKE '%글루트 햄%';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'GLUTES' FROM exercises e WHERE e.name LIKE '%글루트 햄%';

-- 노르딕 컬
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'HAMSTRINGS' FROM exercises e WHERE e.name LIKE '%노르딕%';

-- 백 익스텐션
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'BACK' FROM exercises e WHERE e.name LIKE '%백 익스텐션%';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'GLUTES' FROM exercises e WHERE e.name LIKE '%백 익스텐션%';

-- 슈퍼맨
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'BACK' FROM exercises e WHERE e.name = '슈퍼맨';
INSERT INTO exercise_muscle_groups (exercise_id, muscle_groups)
SELECT e.id, 'GLUTES' FROM exercises e WHERE e.name = '슈퍼맨';